...
appelations.csv
   ...
   Appelation: name of the appelation/AVA/grape-growing region - deleted
...
Appelation: origin of the grapes (see applations.Appelation) - deleted
     State: state of the grapes' origin (same as appelations.State)
      Name: name of the wine - deleted
   ...
   Revenue: revenue of wine = 12 * cases * price
