...
echo Test1==========================================
## TC-1 
## Test Requirements R1, R2
## Given classsroom number, return students and teacher of classroom
## expected output: SAELEE DANILO
##                  GARTH JOHN
##                  FALKER ADOLPH
python schoolsearch.py << Test8
C: 103
C: 103 T
Q
Test8
...
echo Test2==========================================
## TC-2 
## Test Requirements R3
## Given grade, return all teachers of that grade
## expected output: FAFARD ROCIO
##                  ALPERT JONATHAN
python schoolsearch.py << Test9
In: 3
Q
Test9
...
## Give number of students in each classroom
## expected output: 101: 1
##                  102: 5
##                  ...
##                  112: 8
python schoolsearch.py << Test10
E
Q
Test10
...
## Show Avg, High, and Low GPA's given teacher, grade level and bus route
## expected output: Grade: 3
##                  Average GPA: 3.05 High: 3.24 Low: 2.79
##                  Teacher: FALKER
##                  Average GPA: 3.00 High: 3.14 Low: 2.85
##                  Bus Route: 53
##                  Average GPA: 3.06 High: 3.22 Low: 2.79
python schoolsearch.py << Test11
A: 3 G
A: FALKER T
Analytics: 53 B
Q
